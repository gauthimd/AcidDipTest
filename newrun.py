...
class AcidDipTester():
  ...
  def movetoStation(self):
      ...
      lcd.lcd_display_string("   Please Wait...",3) 
      if z = 1: t2 = self.motorStart(143,0) #Figure this mess out here!!!!!!!!!!!!!!!
      if z = 2: t2 = self.motorStart(143,1)
      if z = 3: t2 = self.motorStart(286,1)
      if z = 4: t2 = self.motorStart(143,1)
      self.motorStop(t2)
      self.position = int(x)
